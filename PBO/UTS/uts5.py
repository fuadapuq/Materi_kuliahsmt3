...
class Admin(User):
    def _init_(self, username, email, userId):
        super()._init_(username, email, userId)
        self.users = {}  # Menyimpan pengguna dalam bentuk dictionary
    ...
    def removeUser (self, userId):
        if userId in self.users:
            ...
            print(f"Akun pengguna dengan ID {userId} telah dihapus.")
        else:
            print(f"Tidak ada pengguna dengan ID {userId}.")
...
if _name_ == "_main_":
    ...
    # Menghapus pengguna
    admin1.removeUser (1)  # Menghapus pengguna dengan ID 1
    admin1.removeUser (3)  # Mencoba menghapus pengguna yang tidak ada
    
    # Menghasilkan laporan
    admin1.generateReport("transaksi", "2023-01-01", "2023-12-31")
